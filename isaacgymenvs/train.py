...
def launch_rlg_hydra(cfg: DictConfig):
    ...
    if cfg.task_name == 'DualFranka':
        local_dir = os.getcwd()
        Dualfranka_dir = os.path.join(local_dir, 'tasks/dual_franka.py')
        A2Ccommon_dir = os.path.join(local_dir, 'rl_games/common/a2c_common.py')
        A2Ccontinuous_dir = os.path.join(local_dir, 'rl_games/algos_torch/a2c_continuous.py')
        expectdual_dir = os.path.join(local_dir, experiment_dir, 'dual_franka.py')
        expectcomm_dir = os.path.join(local_dir, experiment_dir, 'a2c_common.py')
        expectcont_dir = os.path.join(local_dir, experiment_dir, 'a2c_continuous.py')
