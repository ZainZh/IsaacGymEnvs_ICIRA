...
class NetworkBuilder:
    def __init__(self):
        ...
        self.network_factory.register_builder('actor_multi_critic', lambda **kwargs: network_builder.A2CMultiBuilder())
...
class ModelBuilder:
    def __init__(self):
        ...
        self.model_factory.register_builder('continuous_a2c_logstd_multi',
                                            lambda network, **kwargs: models.ModelA2CMultiContinuousLogStd(network))
